    ...
    <div className="container mx-auto">
      <div className="flex flex-col xl:flex-row gap-x-8">
        ...
        <div className="text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0">
          ...
          Passionate software developer with expertise in blockchain, metaverse, MERN Stack, and web development. Formerly specialized in Unity game development and AR/VR projects for diverse clients. Check out some of my featured works.
